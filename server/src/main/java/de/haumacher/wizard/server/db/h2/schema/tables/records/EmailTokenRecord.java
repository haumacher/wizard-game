...
public class EmailTokenRecord extends UpdatableRecordImpl<EmailTokenRecord> implements Record3<String, byte[], Long> {
    ...
    @Override
    public EmailTokenRecord value3(Long value) {
        setNotAfter(value);
        return this;
    }

    @Override
    public EmailTokenRecord values(String value1, byte[] value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public EmailTokenRecord(String email, byte[] hash, Long notAfter) {
        super(EmailToken.EMAIL_TOKEN);
