...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record7<String, String, String, String, Long, Boolean, Long> {
    ...
    @Override
    public Row7<String, String, String, String, Long, Boolean, Long> valuesRow() {
    ...
    @Override
    public UsersRecord values(String value1, String value2, String value3, String value4, Long value5, Boolean value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(String uid, String nickname, String email, String language, Long created, Boolean verified, Long lastLogin) {
        super(Users.USERS);
