...
public abstract class Msg extends de.haumacher.msgbuf.data.AbstractDataObject {
	...
	public interface Visitor<R,A,E extends Throwable> extends Result.Visitor<R,A,E> {
		...
		/** Visit case for {@link RequestPut}.*/
		R visit(RequestPut self, A arg) throws E;
	...
	public static Msg readMsg(de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		...
		switch (type) {
			...
			case RequestPut.REQUEST_PUT__TYPE: result = de.haumacher.wizard.msg.RequestPut.readRequestPut(in); break;
