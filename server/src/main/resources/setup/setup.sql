...
CREATE UNIQUE INDEX USERS_NICKNAME_INDEX ON PUBLIC.USERS (NICKNAME);
...
CREATE TABLE PUBLIC.EMAIL_TOKEN (
	UID CHARACTER VARYING(64) NOT NULL,
	EMAIL BINARY VARYING(128) NOT NULL,
	HASH BINARY VARYING(128) NOT NULL,
	NOT_AFTER BIGINT NOT NULL,
	
	CONSTRAINT EMAIL_TOKEN_PK PRIMARY KEY (UID)
);
